...
goog.exportSymbol('proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody', null, global);
 ...
 * @constructor
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.displayName = 'proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody';
}
 ...
 * @return {!Object}
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.toObject = function(opt_includeInstance) {
  return proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody}
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody;
  return proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody}
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.getKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.setKey = function(value) {
 ...
 * @return {string}
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.getCode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.setCode = function(value) {
 ...
 * @return {string}
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.getMessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.setMessage = function(value) {
 ...
 * @return {number}
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.getTimestamp = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/** @param {number} value */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.setTimestamp = function(value) {
 ...
 */
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.getDataMap = function(opt_noLazyCreate) {
...
proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.prototype.clearDataMap = function() {
