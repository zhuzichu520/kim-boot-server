...
CIMPushManager.bind = function (account) {
    ...
    let body = new proto.com.chuzi.imsdk.server.sdk.web.model.SentBody();
...
CIMPushManager.innerOnMessageReceived = function (e) {
    ...
    if (type === MESSAGE) {
        let message = proto.com.chuzi.imsdk.server.sdk.web.model.Message.deserializeBinary(body);
        onInterceptMessageReceived(message.toObject(false));
        return;
    }

    if (type === REPLY_BODY) {
        let message = proto.com.chuzi.imsdk.server.sdk.web.model.ReplyBody.deserializeBinary(body);
